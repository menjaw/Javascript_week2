...
//Call all the functions and understand
...
//If you add the String before the parameters it will just print out everythin without adding the numbers together and ignore the extra parameter 
console.log(add("If you add an extra parameter, it will just be ignored " + 2,2,2));

//Result is NaN (not available number), which means that the value is not a legal number
console.log(add(1));

//Takes the two paramters and make a callback to the add-method
console.log(cb(3,3,add));

//Takes the two paramters and make a callback to the sub-method
...
//This will result in a NaN, because you can't make a substraction with a number and a String
